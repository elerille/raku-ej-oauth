...
my Ej::OAuth::AuthorizationPromise $promise = $oauth.authorization: "Moi", :scope(GitHubScope::repo,);

if $promise.status ~~ Kept {
    # If promise is kept, this is because restored from save
} else {
    # Else you required to display url to user
